...
Не обязательно
Составлять рейтинг коров по количеству собранного молока.
...
При запуске скрипта main.php, дополнительно к общему количеству собранной продукции нужно вывести рейтинг коров по следующим критериям:
3 коровы которые дали больше всего молока;
3 коровы которые дали меньше всего молока.
